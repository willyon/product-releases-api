...
router.get('/config', asyncHandler(licenseController.getPublicConfig))
router.post('/trial/start', asyncHandler(licenseController.startTrial))
router.post('/pro/redeem', asyncHandler(licenseController.redeemPro))
router.post('/refresh', asyncHandler(licenseController.refreshLicense))
...
adminRouter.patch('/codes/device-limit', asyncHandler(licenseController.setLicenseDeviceLimit))
adminRouter.post('/revoke-pro', asyncHandler(licenseController.revokeProLicense))
adminRouter.post('/restore-pro', asyncHandler(licenseController.restoreProLicense))
